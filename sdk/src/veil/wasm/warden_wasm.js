/* @ts-self-types="./warden_wasm.d.ts" */
 ...
 * @param {string} id_hex
 * @param {string} fed_json
 * @returns {string}
 */
function combine(partials_json, id_hex, fed_json) {
    let deferred5_0;
    let deferred5_1;
    try {
        ...
        const ptr2 = passStringToWasm0(fed_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len2 = WASM_VECTOR_LEN;
        const ret = wasm.combine(ptr0, len0, ptr1, len1, ptr2, len2);
        var ptr4 = ret[0];
        var len4 = ret[1];
        if (ret[3]) {
            ptr4 = 0; len4 = 0;
 ...
 * @returns {string}
 */
function condition_identity(condition_json) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(condition_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.condition_identity(ptr0, len0);
        var ptr2 = ret[0];
        var len2 = ret[1];
        if (ret[3]) {
            ptr2 = 0; len2 = 0;
...
exports.condition_identity = condition_identity;
 ...
 * @param {string} d_id_hex
 * @returns {string}
 */
function open_gated(envelope_json, d_id_hex) {
    let deferred4_0;
    let deferred4_1;
    try {
        const ptr0 = passStringToWasm0(envelope_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(d_id_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.open_gated(ptr0, len0, ptr1, len1);
        var ptr3 = ret[0];
        var len3 = ret[1];
        if (ret[3]) {
            ptr3 = 0; len3 = 0;
...
exports.open_gated = open_gated;

/**
 * Gate an already-encrypted `blob` (hex) on `condition` under `master_pub` (hex). Returns the
 * `warden-gate-v1` envelope as JSON.
 * @param {string} condition_json
 * @param {string} master_pub_hex
 * @param {string} network
 * @param {string} blob_hex
 * @returns {string}
 */
function seal_gated(condition_json, master_pub_hex, network, blob_hex) {
    let deferred6_0;
    let deferred6_1;
    try {
        const ptr0 = passStringToWasm0(condition_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(master_pub_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passStringToWasm0(network, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len2 = WASM_VECTOR_LEN;
        const ptr3 = passStringToWasm0(blob_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len3 = WASM_VECTOR_LEN;
        const ret = wasm.seal_gated(ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3);
        var ptr5 = ret[0];
        var len5 = ret[1];
        if (ret[3]) {
            ptr5 = 0; len5 = 0;
...
const wasmPath = `${__dirname}/warden_wasm_bg.wasm`;
